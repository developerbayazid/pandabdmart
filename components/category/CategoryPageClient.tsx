...
export function CategoryPageClient({
    ...
    const handleRemoveFilter = useCallback(
        ...
        [handleBrandToggle, updateParams],
    );
    ...
    const activeFilters = useMemo(() => {
        ...
        return filters;
    }, [selectedBrands, inStockOnly, priceMin, priceMax, filterOptions]);
        ...
        <div className="bg-background min-h-screen">
            <div className="max-w-[1440px] mx-auto px-4 lg:px-16 py-6">
                <CategoryBreadcrumb
                    ...
                    currentName={categoryData.category.name}
                />

                <CategoryHero name={categoryData.category.name} />
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                            {categoryData.children.map((child) => (
                                <Link
                                    ...
                                    className="bg-surface border border-border rounded-xl p-5 hover:bg-surface-secondary transition-colors group"
                                >
                                    <h3 className="text-[14px] font-medium text-text-primary group-hover:text-text-primary">
                                        {child.name}
                                    </h3>
